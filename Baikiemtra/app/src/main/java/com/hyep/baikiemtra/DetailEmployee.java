...
public class DetailEmployee extends AppCompatActivity {
    ...
    private EditText edtName, edtEmail, edtPos, edtPhone, edtDepID;
    private ImageView imfProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imfProfile = findViewById(R.id.imgProfile);
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(DetailEmployee.this).setTitle("Delete Contact").setMessage("Are you sure you want to delete this person?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.close();
                        Intent myIntent = new Intent(DetailEmployee.this, MainActivity.class);
...
//            imfProfile.setImageURI(Uri.parse(img));
